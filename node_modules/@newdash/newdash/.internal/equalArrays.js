...
function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
    ...
    let index = -1;
    let result = true;
    const seen = (bitmask & COMPARE_UNORDERED_FLAG) ? new SetCache_1.default : undefined;
    ...
    while (++index < arrLength) {
        ...
        if (seen) {
            if (!(0, some_1.default)(other, (othValue, othIndex) => {
                if (!(0, cacheHas_1.default)(seen, othIndex) &&
