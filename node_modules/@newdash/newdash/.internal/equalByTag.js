...
const mapToArray_1 = __importDefault(require("./mapToArray"));
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
    ...
    switch (tag) {
        ...
        case setTag:
            ...
            const result = (0, equalArrays_1.default)(convert(object), convert(other), bitmask, customizer, equalFunc, stack);
            stack['delete'](object);
            return result;
        case symbolTag:
            if (symbolValueOf) {
